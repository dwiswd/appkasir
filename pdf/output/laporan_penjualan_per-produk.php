...
//laporan_penjualan_per-produk.php
...
$pdf->setSubject('Laporan Penjualan Per-Produk');
$pdf->setKeywords('App kasir,Laporan Penjualan Per-Produk');
...
$pdf->Output('laporan_penjualan_per-produk.pdf', 'I');
